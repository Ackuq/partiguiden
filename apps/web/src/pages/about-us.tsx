      ...
      <Card>
        <CardContent>
          ...
          <Typography variant="subtitle1" paragraph>
            ...
            <Link href={githubProfile}>GitHub</Link>).
          </Typography>
          <Typography variant="subtitle1" paragraph>
          ...
          <Typography variant="subtitle1" paragraph>
            ...
            <Link href="https://data.riksdagen.se/">Riksdagens öppna API</Link>.
            Viss data om partierna är tagen från{" "}
            <Link href="https://wikipedia.se/">Wikipedia</Link>. Dataunderlaget
            för opinionsundersökningar hämtas genom ett dataset som underhålls
            av Hampus Nilsson, utvecklaren av{" "}
            <Link href="https://val.digital/">val.digital</Link>, och finns
            publikt på&nbsp;
            <Link href="https://github.com/hampusborgos/SwedishPolls">
              GitHub
            </Link>
            .
          </Typography>
          ...
          <Typography variant="subtitle1">
            ...
            alla delar av detta projekt open source på GitHub. Här ligger både
            koden för&nbsp;
            <Link href={githubFrontend}>hemsidan</Link>,{" "}
            <Link href={githubBackend}>backend</Link>, samt den{" "}
            <Link href={githubAdmin}>internt använda adminpanelen</Link>.
          </Typography>
        </CardContent>
      </Card>
    </Container>
